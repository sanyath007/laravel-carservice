...
class AccidentController extends Controller
{
    ...
    public function store (Request $req)
    {
        ...
        if ($assign->save()) {
            ...
            return redirect('/accidents/new')->with('status', 'บันทึกข้อมูลเรียบร้อย');
        } else {
            return redirect('/accidents/new')->with('status', 'พบข้อผิดพลาด');
        }
    ...
    {
        return view('accidents.editform', [
