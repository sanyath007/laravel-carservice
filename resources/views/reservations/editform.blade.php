...
<div class="container-fluid" ng-controller="reserveCtrl" ng-init="loadReservationData({{ $reservation->id }})">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('/reserve/list') }}">รายการขอใช้รถ</a></li>
        <li class="breadcrumb-item active">แก้ไขข้อมูลขอใช้รถ</li>
        <li class="breadcrumb-item active">REV60-{{ $reservation->id }}</li>
    </ol>
